...
c
c       Minpack2 Library ... timer_BDGS, dpmeps.
c
...
c                                open a summary file 'iterate.dat'
            open (78, file = 'iterate.dat', status = 'unknown')
            itfile = 78
         endif            
...
c     to subroutine timer_BDGS to determine the initial and final time.
c
c     The subroutine statement is
c
c       subroutine timer_BDGS(ttime)
c
c     where
c
